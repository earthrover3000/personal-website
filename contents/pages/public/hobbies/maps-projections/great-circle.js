...
(function (r) {
  r.GREAT_CIRCLE = {
    defaults: { boundaries: false, bathymetry: false, topography: false, mercator_edge: false, mercator_edge_gen: false, flight_paths: 'selected' },   // initial control state: borders/terrain/mercator-limits off; preset-routes mode
    routes: {
